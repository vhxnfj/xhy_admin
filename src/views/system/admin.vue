    ...
    <el-card class="app-container">
      <div class="page-tab-box">
        <el-radio-group v-model="activeType" @change="handleClickTab">
          ...
          <el-radio-button :label="item.value+''" v-for="(item,key) in groupList" :key="key">{{item.label}}</el-radio-button>
        </el-radio-group>
      </div>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div style="display: flex;align-items: center;">
              <el-avatar shape="square" :size="50" :src="scope.row.avatar ? scope.row.avatar : 'images/default.gif'"></el-avatar>
...
<script>
  import {getAdmin,addAdmin,saveAdmin,deleteAdmin,deleteListAdmin,stopAdmin,stopListAdmin,openAdmin,openListAdmin} from '@/api/system'
