  ...
  <div class="app-container">
    ...
    <el-dialog
      ...
      <el-form :model="formData" ref="infoForm" label-width="100px" style="width: 500px;">
        ...
        <el-form-item label="最低价" prop="max_count">
        ...
        <el-form-item label="利润率" prop="max_count">
          <el-input v-model="formData.min_rate" style="width: 100px;"></el-input>
          -
          <el-input v-model="formData.max_rate" style="width: 100px;"></el-input>
          %
        </el-form-item>
...
import { getList,getTongji,doGrid } from '@/api/grid_infinite'
