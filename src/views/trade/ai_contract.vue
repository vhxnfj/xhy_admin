  ...
  <div class="app-container">
    ...
    <el-dialog
      ...
      <el-form :model="formData" ref="infoForm" label-width="100px" style="width: 500px;">
        ...
        <el-form-item label="单价区间" prop="max_count">
        ...
        <el-form-item label="杠杆倍数" prop="max_count">
        ...
        <el-form-item label="止盈区间" prop="max_count">
          <el-input v-model="formData.stop_win_start" style="width: 140px;"></el-input>
          -
          <el-input v-model="formData.stop_win_end" style="width: 140px;"></el-input>
        </el-form-item>
        <el-form-item label="止损区间" prop="max_count">
          <el-input v-model="formData.stop_loss_start" style="width: 140px;"></el-input>
          -
          <el-input v-model="formData.stop_loss_end" style="width: 140px;"></el-input>
        </el-form-item>
    ...
    <el-card class="app-container">
      ...
      <el-table
        ...
        <el-table-column
          prop="win_start_price"
          label="止损区间"
          align="center"
          width="140">
          <template slot-scope="{row}">
            <div>止盈：{{row.win_start_price}}</div>
            <div>止损：{{row.loss_start_price}}</div>
          </template>
        </el-table-column>
        <el-table-column
          prop="profit"
...
import { getList,getTongji,doContract } from '@/api/ai_contract'
...
export default {
  ...
  methods:{
    ...
    onSubmit(){
      this.submiting = true;
      doContract(this.formData).then(res=>{
        this.handleCancel();
